...
- La plupart des projets de fertilisation se focalisent sur l’utilisation du fer (sous forme soluble), vu que la quantité de minéraux requise est relativement faible.
> * Dans l’océan, il existe des régions dont les eaux de surface sont riches en macronutriments (comme les nitrates et les phosphates), mais qui contiennent une abondance étonnamment faible de phytoplancton. On les appelle des régions HNLCs (High-nutrient, low-chlorophyll), et elles représentent entre 20 et 30 % de la surface océanique totale. On pense aujourd’hui que la faible abondance de phytoplancton dans les régions HNLC peut s’expliquer, entre autres, par une déficience en fer dans ces eaux de surface.
